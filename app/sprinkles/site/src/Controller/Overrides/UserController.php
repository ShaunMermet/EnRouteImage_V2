...
class UserController extends SimpleController
{
    ...
    public function create($request, $response, $args)
    {
        ...
        Capsule::transaction( function() use ($classMapper, $data, $ms, $config, $currentUser,$grpData) {
            // Create the user
    ...
    public function getList($request, $response, $args)
    {
        ...
        $params['filters']['norights'] = [];
        $usersTmplist = $classMapper->createInstance('user')->all();
        foreach ($usersTmplist as $user) {
            ...
            if (!$authorizer->checkAccess($currentUser, 'update_user_field', [
                ...
                array_push($params['filters']['norights'], $user->id);
            }
        }
